...
#define ERROR_ALREADY_CONNECTED					0x8A
#define ERROR_ESPCONN_ALLOC						0x8B
#define ERROR_SERVER_NOTSTARTED					0x8C
#define ERROR_NOT_IMPLEMENTED					0x8D
#define ERROR_RGPIO_ALLOC						0x8E
#define ERROR_RGPIO_PENDING						0x8F
